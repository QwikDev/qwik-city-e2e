...
export const Cmp = component$<CmpProps>((props) => {
  ...
  return (
    <div>
      ...
      <Cmp2 onClick$={props.onClick0$} render$={props.render$}>
        Click
      </Cmp2>
      <Cmp2 onClick$={props.onClick1$} render$={props.render$}>
        Click
      </Cmp2>
      <Cmp2 onClick$={props.onClick2$} render$={props.render$}>
        Click
      </Cmp2>
      <Cmp2 onClick$={props.onClick3$} render$={props.render$}>
        Click
      </Cmp2>
      <Cmp2 onClick$={props.onClick4$} render$={props.render$}>
        Click
      </Cmp2>
    </div>
  );
